            ...
            <div class="flex">
                ...
                <div class="p-3 w-full">
                    ...
                    <div class="flex mt-10">
                        ...
                        <a href="{{ route('reservasi.edit', 'deluxe') }}" style="margin-left: auto;">
                            <button type="button" class="focus:outline-none text-white font-medium rounded-lg text-sm px-2 py-2.5 me-2 mb-2 bg-green-600 hover:bg-green-700 focus:ring-green-800 w-40">Pesan Sekarang</button>
                        </a>
                    </div>
                </div>
            ...
            <div class="flex">
                ...
                <div class="p-3 w-full">
                    ...
                    <div class="flex">
                        ...
                        <div class=" ml-auto">
                            <p class=" ml-5 mb-3 text-xl font-semibold text-red-600">Sisa {{$executiveCount}} Kamar</p>
                        </div>
                    </div>
                    <div class="flex mt-10">
                        <p class=" ml-5 mb-3 text-orange-500 text-3xl font-semibold">Rp. {{$harga_executive}}</p>
                        <a href="{{ route('reservasi.edit', 'executive') }}" style="margin-left: auto;">
                            <button type="button" class="focus:outline-none text-white font-medium rounded-lg text-sm px-2 py-2.5 me-2 mb-2 bg-green-600 hover:bg-green-700 focus:ring-green-800 w-40">Pesan Sekarang</button>
                        </a>
                    </div>
                </div>
