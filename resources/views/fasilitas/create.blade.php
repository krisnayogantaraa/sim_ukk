...
@section('content')
<p class="text-5xl mb-3 text-gray-900 dark:text-white">DAFTAR FASILITAS BARU</p>
<form action="{{ route('fasilitas.store') }}" method="POST" enctype="multipart/form-data">
    @csrf

    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label for="Nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Fasalitas</label>
